...
function asCard(cancion) {
    ...
    let html = `
        <td scope="col"><span class="badge rounded-pill" style="background-color: ${num1}; color: black; width: 100px; text-align: left; display: inline-block;">${reentrada}${cancion.titulo}</span></td>
        `;
